...
//
public  Vector<Gasolinera> selectGasolinera(String id){
	...
	try{
		...
		while ( reg.next()){
			...
			listadoGasolinera.add(new Gasolinera(reg.getInt(1),reg.getString(2),reg.getString(3),reg.getString(4),reg.getString(5),reg.getInt(6),reg.getString(7),reg.getString(8).charAt(0),reg.getFloat(9),reg.getFloat(10),reg.getString(11),reg.getString(12)));
		}
		s.close();
		this.cerrar();
